...
def process_image(image_input):
    ...
    text, ocr_bbox = check_ocr_box(image_save_path, display_img=False, output_bb_format='xyxy')
    _, _, parsed_content_list = get_som_labeled_img(
        image_save_path, yolo_model, BOX_TRESHOLD=0.05, output_coord_in_ratio=True, ocr_bbox=ocr_bbox, caption_model_processor=caption_model_processor
    )
